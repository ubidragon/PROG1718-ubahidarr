...
public class ES {
     ...
     * @return El número real leído.
     */
    public static float leeReal(float minimo, float maximo) throws IllegalArgumentException  {
        float numero = 0;
        boolean leido = false;
        Scanner teclado = null;
     ...
     * @return El número real leído.
     */
    public static float leeReal(String mensaje, float minimo, float maximo) throws IllegalArgumentException  {
        float numero = 0;
        boolean leido = false;
        Scanner teclado = null;
        // Si el valor mínimo es mayor que el máximo, lanzamos una excepción
