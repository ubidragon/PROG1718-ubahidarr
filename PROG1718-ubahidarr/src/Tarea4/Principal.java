...
import Tarea4.utilidades.ES;

/**
 * <p>Clase de prueba para el proyecto de sopas de letras.</p>
 * <p>Contiene el programa principal que permite probar el funcionamiento de la 
 * clase <code>SopaLetras.</code></p>
 * <p>Lleva a cabo las siguientea acciones:</p>
 * <ol>
 * <li>Solicitar por teclado el número de filas y de columnas para una nueva sopa de letras.</li>
 * <li>Crear la sopa de letras.</li>
 * <li>Pedir por teclado una palabra para insertar
 * en la sopa de letras. Comprobar que esa palabra es válida. Si no es así,
 * volver a pedir otra palabra hasta que se cumplan los requisitos.</li>
 * <li>Solicitar la ubicación (fila y columna) de la primera letra de la palabra que se desea
 * colocar, así como la dirección de inserción (horizontal, vertical, diagonal1, diagonal2).</li>
 * <li>Comprobar si con esa información de colocación (ubicación de la
 * primera letra más la dirección de inserción) es posible incrustar la palabra
 * en la sopa de letras. Si la inserción es posible, se llevará a cabo y así se
 * indicará por pantalla. Si no es posible, no se hará la inserción y también se
 * informará de ello.</li>
 * <li>Por último preguntará si se quiere continuar iterando en
 * el programa, intentando insertar una nueva palabra en la sopa de letras.</li>
 * <li>Cuando finalmente no se deseen insertar más palabras, el bucle principal de
 * la aplicación finalizará y mostrará el contenido completo de la sopa de
